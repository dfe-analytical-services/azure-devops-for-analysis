...
This section outlines some useful commands to make Git a little more use fridendly.
...
For example, using the long, customised log from above we can define a new commmand, "hist".
...
If you've just committed some changes but realised a mistake in them you can "amend" the commit. However, this should be done before you push your changes! Things can get complicated if you try ammending public commits.
