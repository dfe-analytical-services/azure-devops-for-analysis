...
* <img src="www/images/chapter2_RStudio_gitpaneDiff.PNG" alt="Git diff icon" height="16"/>  Open the [RStudio review changes window](#branches-committing-and-pushing);
* <img src="www/images/chapter2_RStudio_gitpaneCommit.png" alt="Git commit icon" height="16"/> Also opens the [RStudio review changes window](#branches-committing-and-pushing);
* <img src="www/images/chapter2_RStudio_gitpanePull.png" alt="Git pull icon" height="16"/> Perform a pull;
* <img src="www/images/chapter2_RStudio_gitpanePush.png" alt="Git push icon" height="16"/> Push the current commits;
* <img src="www/images/chapter2_RStudio_gitpaneHistory.png" alt="Git history icon" height="16"/> Open the [RStudio review changes window](#branches-committing-and-pushing), defaulting to the History panel;
* <img src="www/images/chapter2_RStudio_gitpaneProjectSettings.png" alt="Project seeings icon" height="16"/> Open the project settings window;
* <img src="www/images/chapter2_RStudio_gitpaneNewBranch.png" alt="New branch icon" height="16"/> Create a new branch;
* <img src="www/images/chapter2_RStudio_gitpaneSelectBranch.png" alt="Current branch" height="16"/> Shows the current branch and allows the user to switch branches via the drop down list;
* <img src="www/images/chapter2_RStudio_gitpaneRefresh.png" alt="Refresh icon" height="16"/> Refresh the git pane preview.
