...
* ![RStudio git Diff Icon](www/images/chapter2_RStudio_gitpaneDiff.PNG)  Open the [RStudio review changes window](#branches,-committing,-pulling-and-pushing)
* ![RStudio git commit Icon](www/images/chapter2_RStudio_gitpaneCommit.png) Open the [RStudio review changes window](#branches,-committing,-pulling-and-pushing) (no this is not a typo that this does the same as the Diff button!)
* ![RStudio git pull Icon](www/images/chapter2_RStudio_gitpanePull.png) Perform a pull
* ![RStudio git push Icon](www/images/chapter2_RStudio_gitpanePush.png) Push the current commits
* ![RStudio git history Icon](www/images/chapter2_RStudio_gitpaneHistory.png) Open the [RStudio review changes window](#branches,-committing,-pulling-and-pushing), defaulting to the History panel
* ![RStudio git Project Settings Icon](www/images/chapter2_RStudio_gitpaneProjectSettings.png) Open the project settings window
* ![RStudio git new branch Icon](www/images/chapter2_RStudio_gitpaneNewBranch.png) Create a new branch
* ![RStudio git select branch Icon](www/images/chapter2_RStudio_gitpaneSelectBranch.png) Shows the current branch and allows the user to switch branches via the drop down list
* ![RStudio git refresh Icon](www/images/chapter2_RStudio_gitpaneRefresh.png) Open the commit window
...
The bulk of any adding, committing and pushing activities using the RStudio GUI is done using the Review changes window. This can be opened either by selecting `File` > `Commit...` from the RStudio menu bar, or clicking `Diff`, `Commit` or ![RStudio git history Icon](www/images/chapter2_RStudio_gitpaneHistory.png) in the RStudio git pane.
