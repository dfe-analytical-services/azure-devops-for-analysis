...
* ![RStudio Diff Icon](www/images/chapter2_RStudio_gitpaneDiff.PNG)  Open the [Diff window](#diff-gui)
* ![RStudio Diff Icon](www/images/chapter2_RStudio_gitpaneCommit.png) Open the commit window
...
* ![RStudio Diff Icon](www/images/chapter2_RStudio_gitpaneHistory.png) Open the project history window
