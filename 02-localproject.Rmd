...
```
to add just speed_dist.R (notice how last time we used ```git add .``` to add everything, but explicitly named the file hereas we don't want to add the .png file).
