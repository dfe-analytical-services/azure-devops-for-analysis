...
Now we do the usual `sh git add` and `sh git commit`. Make note of the merge conflict in the commit message, something like "Fixed merge conflict between blue and red".
