...
VSTS offers unlimitted private repositories for 5 users. If you sign up via your corporate email you can create a site that is secure within the organisations active directory and store your code securely.
...
1. Give background to the changes made and link any work items (can be enforced as recommended previosuly).
...
4. Presents the differences between the two branches in a visual manner (added/removed) so that you can easily see exatly what has been changed.
