...
Git works in such a way that each time you make a change it is not a new version of the code that is stored, but the differences between the current code and the previous version. 
