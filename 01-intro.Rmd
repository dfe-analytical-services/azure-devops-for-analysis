...
One of the most well known systems for this is [GitHub](https://github.com) which is popular with open source projects. Some companies pay for business accounts. 

For the purposes of this book we look at using Azure DevOps. This common tool for enterprise for software development provides us a secure set-up which integrates well with our Windows (AAD) log ins. As such, this should be our collaboration tool of choice.
