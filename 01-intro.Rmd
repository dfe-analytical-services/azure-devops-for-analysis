...
Put another way, Azure DevOps and Github do the same job. Git does a different job, and can interact with either of them. In DfE we by default use the combination of Git and Azure DevOps, although Git and Github will sometimes be used where appropriate.
