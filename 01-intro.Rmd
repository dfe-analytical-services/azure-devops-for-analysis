...
![Poor version control involves duplicating files and no standardised naming process.](www/manual_version_control.png)
...
![A diagram to demonstrate branching with Git.](www/branching_diagram.png)
