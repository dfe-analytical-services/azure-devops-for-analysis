...
For the purposes of this book we are looking at using Azure DevOps. This is a common tool in enterprise for software development and the reason we use it over GitHub is that it is secure. 
