...
![Some example work items in DevOps.](www/images/chapter4_work_items.png)
...
branch in your local repository and pull in case anyone else had made changes.
```sh 
git checkout main
```
```sh 
...
![An example of a merge conflict in DevOps.](www/images/chapter4_merge_conflict.png)
...
![An example of using tags within a repository.](www/images/chapter4_tags.png)
