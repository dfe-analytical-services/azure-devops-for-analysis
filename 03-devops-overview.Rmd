...
![Visual illustrating the concept of server and local copies.](www/distributed_version_control.png)
...
![Pull requests facilitate QA by other analysts.](www/images/chapter3_pull_request.png)
...
![An example pull request, showing the ability to add comments and provide feedback on new pieces of code.](www/images/chapter3_pull_request_example.png)
...
DevOps will delete the branch you were working in (the source branch) once the pull request is complete.
